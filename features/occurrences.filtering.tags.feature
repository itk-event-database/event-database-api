Feature: Events
  ...
  #   When I send a "GET" request to "/api/occurrences?tags=b"
  #   And the JSON node "hydra:member" should have 1 element
  #   And the JSON node "hydra:member[0].@id" should be equal to "/api/occurrences/2"

  #   When I send a "GET" request to "/api/occurrences?tags=c"
  #   And the JSON node "hydra:member" should have 1 element
  #   And the JSON node "hydra:member[0].@id" should be equal to "/api/occurrences/3"

  # Scenario: Get occurrences by tag list
  #   When I send a "GET" request to "/api/occurrences?tags=a,c"
  #   And the JSON node "hydra:member" should have 1 element
  #   And the JSON node "hydra:member[0].@id" should be equal to "/api/occurrences/3"

  #   When I send a "GET" request to "/api/occurrences?tags=a,b"
  #   And the JSON node "hydra:member" should have 0 elements

  # Scenario: Get occurrences by multiple tags
  #   When I send a "GET" request to "/api/occurrences?tags[]=a&tags[]=c"
  #   And the JSON node "hydra:member" should have 2 elements
  #   And the JSON node "hydra:member[0].@id" should be equal to "/api/occurrences/1"
  #   And the JSON node "hydra:member[1].@id" should be equal to "/api/occurrences/3"

  #   When I send a "GET" request to "/api/occurrences?tags[]=a&tags[]=b"
  #   And the JSON node "hydra:member" should have 3 elements
  #   And the JSON node "hydra:member[0].@id" should be equal to "/api/occurrences/1"
  #   And the JSON node "hydra:member[1].@id" should be equal to "/api/occurrences/2"
  #   And the JSON node "hydra:member[2].@id" should be equal to "/api/occurrences/3"
