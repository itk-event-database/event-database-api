Feature: Events
  ...
  #   When I authenticate as "api-write"
  #   And I send a "GET" request to "/api/events?order[occurrences.startDate]=desc"
  #   And the JSON node "hydra:member" should have 2 elements
  #   And the JSON node "hydra:member[0].@id" should be equal to "/api/events/2"
  ...
  #   When I authenticate as "api-write"
  #   And I send a "GET" request to "/api/events?occurrences.place.name=Place 1"
  #   And the JSON node "hydra:member" should have 1 element
  #   And the JSON node "hydra:member[0].@id" should be equal to "/api/events/1"

  # Scenario: Filter by place name
  #   When I authenticate as "api-write"
  #   And I send a "GET" request to "/api/events?occurrences.place.name=Place 2"
  #   And the JSON node "hydra:member" should have 1 element
  #   And the JSON node "hydra:member[0].@id" should be equal to "/api/events/2"
